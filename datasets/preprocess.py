...
parser.add_argument('--dataset', default='trivago', help='dataset name: diginetica/yoochoose/sample')
...
# 7 days for test
splitdate = 0
if opt.dataset == 'yoochoose' or opt.dataset == 'trivago':
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tra, open('diginetica/train.pkl', 'wb'), 0)
    pickle.dump(tes, open('diginetica/test.pkl', 'wb'), 0)
    pickle.dump(tra_seqs, open('diginetica/all_train_seq.pkl', 'wb'), 0)
elif opt.dataset == 'yoochoose':
    if not os.path.exists('yoochoose1_4'):
        os.makedirs('yoochoose1_4')
    if not os.path.exists('yoochoose1_64'):
        os.makedirs('yoochoose1_64')
    pickle.dump(tes, open('yoochoose1_4/test.pkl', 'wb'))
    pickle.dump(tes, open('yoochoose1_64/test.pkl', 'wb'))
    ...
    pickle.dump(tra4, open('yoochoose1_4/train.pkl', 'wb'))
    pickle.dump(seq4, open('yoochoose1_4/all_train_seq.pkl', 'wb'))

    pickle.dump(tra64, open('yoochoose1_64/train.pkl', 'wb'))
    ...
    if not os.path.exists('sample'):
        os.makedirs('sample')
    pickle.dump(tra, open('sample/train.pkl', 'wb'))
    pickle.dump(tes, open('sample/test.pkl', 'wb'))
    pickle.dump(tra_seqs, open('sample/all_train_seq.pkl', 'wb'))
